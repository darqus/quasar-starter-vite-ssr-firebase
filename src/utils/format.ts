 ...
 * @return {string}
 */
export const incline = (number: number, titles: string[], full: boolean = false): string => {
...
export const toCapitalCase = (input: string): string => input.charAt(0).toUpperCase() + input.slice(1)
